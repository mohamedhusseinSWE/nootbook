            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <div className="flex items-center">
                    <Badge
                      className={`${getStatusColor(userData?.subscriptionStatus || (user?.stripeSubscriptionId ? "active" : "free"))} flex items-center`}
                    >
                      {getStatusIcon(userData?.subscriptionStatus || (user?.stripeSubscriptionId ? "active" : "free"))}
                      <span className="ml-1 capitalize">
                        {userData?.subscriptionStatus || (user?.stripeSubscriptionId ? "active" : "free")}
                      </span>
                    </Badge>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-lg font-semibold text-gray-900 flex items-center">
                    ...
                    {userData?.planName || userPlan?.name || (user?.stripeSubscriptionId ? "Pro Plan" : "Free Plan")}
                  </p>
                </div>
                <div>
                  <label className="text-sm font-medium text-gray-500">
                  ...
                  <p className="text-lg font-semibold text-gray-900">
                    {userPlan
                      ...
                      : userData?.planName === "Pro" || user?.stripeSubscriptionId
                        ? "Premium Plan"
                        : "Free"}
                  </p>
                </div>
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-600">
                    {userPlan?.description || (user?.stripeSubscriptionId ? "Premium features included" : "Basic features")}
                  </div>
                </div>
              </div>
            </CardContent>
